				...
				cordova.plugins.notification.local.cancel(notification.id, function() {
					...
					confirmPopup.then(function(res) {
						if (res) {
							...
							$http
							.get(`https://smartserver1.herokuapp.com//incPoints/${selectedParking.publisherId}/1`)
							...
							.success(function(response) {
								...
								$http
								.get(`https://smartserver1.herokuapp.com//setParking/${selectedParking.parkingId}/false`)
							...
							myPopup.then(answer => {
								...
								if (answer != selectedParking.carId)
									points *= (-1);
								$http
								.get(`https://smartserver1.herokuapp.com//incPoints/${selectedParking.publisherId}/${points}`)
								//http://smartserver1.herokuapp.com/
								//http://localhost:8000/
								//https://smartparkil.herokuapp.com/
								.success(function(response) {
