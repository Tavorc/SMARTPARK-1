	...
	angular
		...
		.controller('inCtrl', ['$scope', '$http', '$state', '$stateParams', '$location', '$localStorage', 'UserService', '$ionicLoading', 'd3TimeFormat', '$ionicPopup', '$rootScope',// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			function($scope, $http, $state, $stateParams, $location, $localStorage, UserService, $ionicLoading, d3TimeFormat, $ionicPopup, $rootScope) {
			$scope.location = {};
			var registerLocation = $scope.$watch('$root.location', function() {
				if($rootScope.location){
					$scope.location = {
						country: $rootScope.location.country,
						city: $rootScope.location.city,
						street: $rootScope.location.street,
						number: $rootScope.location.number,
						lat: $rootScope.location.lat,
						lng: $rootScope.location.lng
					}
					$scope.booking.location = $scope.location;
			...
			function($scope, $http, $state, $stateParams, $cordovaCamera, $localStorage, $ionicLoading, UserService, $ionicPush, d3TimeFormat, $rootScope) {
				...
				var registerLocation = $scope.$watch('$root.location', function() {
					if($rootScope.location){
						...
						$scope.parking.location = $scope.location;
		...
		.controller('selectionMapCtrl', ['$scope', '$state', '$http', '$stateParams', '$ionicLoading', '$localStorage', '$rootScope', '$ionicHistory',// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			function($scope, $state, $http, $stateParams, $ionicLoading, $localStorage, $rootScope, $ionicHistory ) {
				$scope.init = function() {
					$scope.chosenLocation;
					...
					$scope.goup = function() {
						// $ionicHistory.backView().stateParams = $scope.chosenLocation;
						$rootScope.location = $scope.chosenLocation;
						console.log('back!');
